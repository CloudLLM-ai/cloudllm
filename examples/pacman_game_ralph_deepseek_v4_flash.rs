...
//! complete Pac-Man game in a single `pacman_game_ralph.html` file.
//!
...
//! `pacman_game_ralph.html` in the current directory.
    ...
    )?));
    {
        ...
        db.append(
            ...
            "Pac-Man RALPH run starting: four agents will implement a full classic Pac-Man page \
             ...
             pacman_game_ralph.html. Non-negotiables: fixed-rate simulation, moderate pacing, \
...
pacman_game_ralph.html (all presentation and behavior inline; no external libraries, fonts, \
or assets).\n\n\
\
## Memory architecture\n\
...
- write_game_file: write the complete game page to pacman_game_ralph.html and session Memory; \
